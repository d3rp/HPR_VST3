...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=hpr Demo Installer\n"
      else:
        line="OutputBaseFilename=hpr Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the hpr Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the hpr installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=hpr Demo installer\n"
     else:
       line="SetupWindowTitle=hpr installer\n"
