...
def main():
  ...
  plistpath = scriptpath + "/resources/hpr-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/hpr-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/hpr-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/hpr-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/hpr-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/hpr.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/hpr.iss",inplace=1):
